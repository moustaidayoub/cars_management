 ...
 * @author Moustaid
 */
public class IHMUpdateVehicule extends javax.swing.JFrame {
...
private String matricule;
     ...
     */
    public IHMUpdateVehicule(String matricule) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Gestion Véhicules OCP - Modification véhicule");
        setResizable(false);
        ...
        labRechercherPar.setText("Modification de Véhicule");
        ...
        btnAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/btnUpdate.png"))); // NOI18N
        btnAdd.setToolTipText("Modifier");
    ...
    private void btnAddMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseEntered
        btnAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/btnUpdate2.png"))); // NOI18N
...
v=vDAO.read(matricule);
txtMatricule.setText(matricule);
txtKM.setValue(v.getKilometrage());
comboMarque.setSelectedItem(v.getMarque().getIdMarque()+":"+v.getMarque().getNomMarque());
comboCategorie.setSelectedItem(v.getCategorie().getIdCategorie()+":"+v.getCategorie().getNomCategorie());
 comboLieu.setSelectedItem(v.getLieu().getIdLieu()+":"+v.getLieu().getNomLieu());
comboCouleur.setSelectedItem(v.getCouleur());
txtDate.setText(v.getDateAjout());
...
Lieu l=new Lieu();
Vehicule v=new Vehicule();
if(vDAO.isMatriculeExiste(txtMatricule.getText()) && !txtMatricule.getText().equals(matricule))
